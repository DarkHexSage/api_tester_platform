...
- [ ] Test basic endpoints on both APIs
...
- [ ] Register users on both APIs
- [ ] Compare password handling
...
3. **Document Findings**
   ...
   - Note status codes and timings
   - Compare security features

4. **Understand Context**
   - Remember insecure API is intentionally vulnerable
   - It's for educational purposes only
   - Never deploy insecure patterns to production
